...
import com.adobe.aem.guides.bright.core.models.HtlSightly;
...
public class HtlSightlyImpl implements HtlSightly{
	 private static final Logger LOG = LoggerFactory.getLogger(HtlSightlyImpl.class);
	    final protected static String RESOURCE_TYPE="/bright/components/htlsightly";
	    ...
	    @ResourcePath(path="/content/bright/us/en/test222222")@Via("resource")
